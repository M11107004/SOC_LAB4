...
.Ltext0:
	...
	.file 0 "/home/ubuntu/Desktop/lab4/Lab4-1/lab-exmem_fir/testbench/counter_la_fir" "fir.c"
	.globl	taps
	.data
	.align	2
	.type	taps, @object
...
.L7:
	...
	add	a5,a4,a5
	lw	a3,0(a5)
	.loc 1 15 46 discriminator 3
	lw	a4,-20(s0)
	lw	a5,-24(s0)
	sub	a5,a4,a5
	.loc 1 15 44 discriminator 3
	lui	a4,%hi(taps)
	addi	a4,a4,%lo(taps)
	slli	a5,a5,2
	add	a5,a4,a5
...
.LASF0:
	.string	"fir.c"
.LASF1:
	.string	"/home/ubuntu/Desktop/lab4/Lab4-1/lab-exmem_fir/testbench/counter_la_fir"
